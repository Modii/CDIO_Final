...
public class ProduktBatches {
	public void handleAdminiProduktBatch(HttpServletRequest request, HttpServletResponse response, 
	...
	public void handleCreateProduktBatch(ServletRequest request, ServletResponse response, 
	...
	public void handleShowProduktBatch(HttpServletRequest request, HttpServletResponse response, 
			IFunctionality funktionalitetsLaget) throws ServletException, IOException, DALException {
		...
		for (int i=0; i < produktbatch.size(); i++) {
			...
			html += "<tr><td>"+produktbatchid+"</td><td>"+receptid+"</td><td>"+dato+"</td><td>"
					+statusToString(status)+"</td><td><form action='' method='POST'>" +
					"<input type='hidden' name='pbId' value='"+produktbatchid+"'>" +
					"<input type='submit' value='Udskriv' name='udskriv'></form></td></tr>";
		}
		html +="</table>";
	...
	public void handlePrintProduktBatch(HttpServletRequest request, HttpServletResponse response, 
			IFunctionality funktionalitetsLaget) throws ServletException, IOException, DALException {
	...
	public void handleCreateProduktBatchSubmit(HttpServletRequest request, HttpServletResponse response, 
			IFunctionality funktionalitetsLaget) throws ServletException, IOException, DALException {
		...
		if (errorMsg.length() == 0) {
			funktionalitetsLaget.getProduktBatchDAO().createProduktBatch
			(new ProduktBatchDTO(produktbatchid,receptid,startDato, slutDato, status));
